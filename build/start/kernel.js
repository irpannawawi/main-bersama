...
Server_1.default.middleware.registerNamed({
    ...
    verify: () => Promise.resolve().then(() => __importStar(global[Symbol.for('ioc.use')]('App/Middleware/Verify'))),
    strictUser: () => Promise.resolve().then(() => __importStar(global[Symbol.for('ioc.use')]('App/Middleware/StrictUser'))),
    adminOnly: () => Promise.resolve().then(() => __importStar(global[Symbol.for('ioc.use')]('App/Middleware/AdminOnly')))
});
